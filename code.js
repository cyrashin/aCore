...
const welcomeMessage = "Welcome to the Aegis Core discord channel! Please verify by saying **-verify** in the verify channel. Verifying using this bot will not grant you roles! **If you're a returning member, all of your valor will be saved. Contact an Admiral+ to recieve your rank back.**";
const maxXP = 15;
